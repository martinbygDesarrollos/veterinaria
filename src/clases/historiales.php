...
class historiales{
	...
	public function getHistoriaClinica($idHistoriaClinica){
		...
		if($responseQuery->result == 1)
			...
			$responseQueryFiles = DataBase::sendQuery("SELECT idMedia, nombre, ruta FROM media WHERE categoria = ? AND idCategoria = ?", array('si', "historiasclinica", $idHistoriaClinica), "LIST");
